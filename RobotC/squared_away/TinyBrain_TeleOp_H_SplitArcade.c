...
#pragma config(Motor,  motor1,          armMotorR,     tmotorVexIQ, PIDControl, encoder)
#pragma config(Motor,  motor3,          rightMotor,    tmotorVexIQ, PIDControl, encoder)
#pragma config(Motor,  motor6,          clawMotor,     tmotorVexIQ, PIDControl, encoder)
#pragma config(Motor,  motor7,          armMotorL,     tmotorVexIQ, openLoop, reversed)
#pragma config(Motor,  motor10,         leftMotor,     tmotorVexIQ, PIDControl, reversed, encoder)
#pragma config(Motor,  motor12,         hMotor,        tmotorVexIQ, PIDControl, reversed, encoder)
...
int iChA_filtered=0, iChC_filtered=0, iChB_filtered=0;
//
...
*/
	...
	repeat (forever)
	{
		...
		iChB_filtered=iTurnMapping[abs(getJoystickValue(ChB))]*sgn(getJoystickValue(ChB));
		...
		setMotorSpeed(hMotor, iChB_filtered);

		if (getJoystickValue(BtnRUp)==1)
		{
			setMotorSpeed(armMotorL, 100);
			setMotorSpeed(armMotorR, 100);
		}
		...
		{
			setMotorSpeed(armMotorL, 0);
			setMotorSpeed(armMotorR, 0);
		}
