...
#pragma config(Motor,  motor5,          armMotor0,     tmotorNone, openLoop)
#pragma config(Motor,  motor6,          rightMotor,    tmotorVexIQ, PIDControl, reversed, driveRight, encoder)
#pragma config(Motor,  motor11,         armMotor1,     tmotorVexIQ, PIDControl, reversed, encoder)
...
*/
	...
	repeat (forever)
	{
		...
		{
			setMotorSpeed(armMotor0, 100);
			setMotorSpeed(armMotor1, 100);
		}
		...
		{
			setMotorSpeed(armMotor0, 0);
			setMotorSpeed(armMotor1, 0);
		}
