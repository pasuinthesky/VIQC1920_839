...
#pragma config(Motor,  motor7,          scoopMotor,        tmotorVexIQ, PIDControl, reversed, encoder)
#pragma config(Motor,  motor8,          armMotorR,     tmotorVexIQ, PIDControl, encoder)
#pragma config(Motor,  motor9,          armMotorL,     tmotorVexIQ, openLoop, reversed)
#pragma config(Motor,  motor11,         rightMotor,    tmotorVexIQ, PIDControl, encoder)
