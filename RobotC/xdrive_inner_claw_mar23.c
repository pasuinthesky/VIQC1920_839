...
#define CLAW_GRAB 0
#define CLAW_RELEASE 370
#define CLAW_PUSH 175
...
void right_side_3_3_3_stable()
{
	...
	desired_heading = -130;
	strafePID(3, -80, 90, 0.18, 0, 0, 10);

	setMotorTarget(armMotor, 40, 100);
	setMotorTarget(clawMotor, CLAW_PUSH, 100);

	desired_heading = -90;
	strafePID(3, -47, 90, 0.18, 0, 0, 2);
