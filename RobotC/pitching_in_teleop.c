...
void initialize()
{
	...
	setMotorBrakeMode(catapultR, motorHold);
	setMotorBrakeMode(catapultL, motorHold);
}
/*
...
*/
	...
	while(true)
	{
		...
		{
			setMotorSpeed(catapultL, 100);
			setMotorSpeed(catapultR, 100);
		}
		else
		{
			setMotorSpeed(catapultL, 0);
			setMotorSpeed(catapultR, 0);
		}
