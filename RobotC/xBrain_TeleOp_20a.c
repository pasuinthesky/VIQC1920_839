...
#pragma config(Motor,  motor5,          BR,            tmotorVexIQ, PIDControl, encoder)
#pragma config(Motor,  motor6,          FR,            tmotorVexIQ, PIDControl, encoder)
#pragma config(Motor,  motor7,          FL,            tmotorVexIQ, PIDControl, encoder)
...
int strafeSpeed;
int iArmLevel[LIFT_LEVELS] = {10, 430};
int in_between_level = 330;
