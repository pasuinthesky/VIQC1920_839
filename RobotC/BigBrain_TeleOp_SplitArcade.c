...
#pragma config(Motor,  motor8,          armMotor,      tmotorVexIQ, PIDControl, encoder)
...
#pragma config(Motor,  motor6,          tailMotor,     tmotorVexIQ, PIDControl, encoder)
...
task main()
{
    ...
    if (getJoystickValue(BtnRUp)== 1)
		...
		{
			setMotorSpeed(tailMotor, -1*TAIL_SPEED);
		}
		else if (getJoystickValue(BtnFDown)==1)
		{
			setMotorSpeed(tailMotor, TAIL_SPEED);
		}
		else
		{
