#pragma config(Motor,  motor6,         leftMotor,    tmotorVexIQ, PIDControl, encoder, driveLeft, reversed)
#pragma config(Motor,  motor12,        rightMotor,   tmotorVexIQ, PIDControl, encoder, driveRight)
...
task main()
{
    ...
    if (getJoystickValue(BtnRUp)== 1)
		...
		{
			setMotorSpeed(intaekMotor, INTAKE_SPEED);
		}
		else
		{
